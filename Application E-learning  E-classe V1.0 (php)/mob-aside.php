<?php
 echo '<div id="sidebar2" class="position-sticky top-0 start-0">
 ...
 <div class="card w-100 mx-auto mt-4">
   ...
   <div class="list-group mt-5 mb-5 w-100">
     <a href="#" class="list-group-item list-group-item-action text-center"> <i class="bi bi-house-door pe-3"></i></a>
     <a href="#" class="list-group-item list-group-item-action text-center"><i class="bi bi-bookmark pe-3"></i></a>
     <a href="student.php" class="list-group-item list-group-item-action text-center"><i class="bi bi-mortarboard pe-3"></i></a>
     <a href="payment.php" class="list-group-item list-group-item-action text-center"><i class="bi bi-currency-dollar pe-3"></i></a>
