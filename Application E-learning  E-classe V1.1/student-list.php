   ...
   <div class="row my-3 pt-3 border-none rounded-3 bg-white">
     <div class="col ">
       ...
       <div class="col  text-start pt-3">
        ...
        <a href="editstudent.php?id=<?= $input['id'] ?>"><i style="color:#00C1FE ;" class="bi bi-pencil pe-3"></i></a>
        <a href="delet.php?id=<?= $input['id'] ?>"> <i style="color:#00C1FE ;" class="bi bi-trash"></i></a>
       </div>
     </div>
<?php
 endforeach;
